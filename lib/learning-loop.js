...
class LearningLoop {
  ...
  learnFromOrchestratorDecision(decision) {
    ...
    // Store decision in vector memory for semantic similarity matching
    try {
...
const learningLoop = globalThis.__learningLoop = globalThis.__learningLoop || new LearningLoop();
