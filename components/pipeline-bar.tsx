...
import type { CustomPipeline } from '@/types/state';

const SEG: Record<string, string> = { idle: 'bg-border', running: 'bg-amber-400', passed: 'bg-green-400', failed: 'bg-red-400' };
...
export default function PipelineBar() {
  ...
  const [editPipeline, setEditPipeline] = useState<CustomPipeline | null>(null);
      ...
      <div className="bg-card border border-border rounded-xl p-5 mb-6">
        ...
        <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
          ...
          <div className="flex gap-2">
            ...
            {isCustom && (
              <>
                <button className="btn-mini" onClick={() => { setEditPipeline(selected as CustomPipeline); setShowEditor(true); }}>
                  {'\u270e'} Edit
                </button>
                <button
